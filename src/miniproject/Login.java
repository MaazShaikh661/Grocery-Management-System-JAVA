...
public class Login
{
    ...
    {        
        ...
        try{img2 = ImageIO.read(new File("F:\\MiniProject JAVA\\src\\miniproject\\black.png"));}
        catch(IOException e){System.out.println(e);}
        ...
        label.setBounds(240,375,2500,100);
        jf1.add(label);
        ...
        la.setFont(F1);
        int lax = (d.width/2);
    	la.setBounds(lax-100,150,2000,60);
        ...
        lb.setFont(F2);
    	lb.setBounds(lax-480,250,200,60);
        lb.setForeground(Color.white);
    	jf1.add(lb);
        
        JLabel lc=new JLabel("PASSWORD ");
        lc.setFont(F2);
    	lc.setBounds(lax-480,300,300,70);
    ...
    public static void loginpage()
    {
        ...
        JLabel la=new JLabel("Grocery Management System ");
        la.setFont(F1);
        int lax = (d.width/3);
    	la.setBounds(lax+93,425,700,35);
        la.setForeground(Color.white);
    	jf1.add(la);
        
        F1=new Font("Agency FB",Font.BOLD,60);
        
        JLabel lb1=new JLabel("    G  M  S");
        lb1.setFont(F1);
    	lb1.setBounds(lax+142,300,700,50);
        ...
        jb1.setFont(F1);
        jb1.setBounds(lax+100,500,180,50);
        jb1.setForeground(Color.black);
        jb1.setBackground(Color.white);
        jb1.addActionListener(new ActionListener()
    	{
        ...
        jb2.setFont(F1);
        jb2.setBounds(lax+340,500,180,50);
        jb2.setForeground(Color.black);
        jb2.setBackground(Color.white);
        jb2.addActionListener(new ActionListener()
    	{

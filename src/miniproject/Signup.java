...
public class Signup 
{
    ...
    public static void sp()
    {
        ...
        la.setFont(F1);
        int lax = (d.width/2);
    	la.setBounds(lax-600,100,2000,60);
